            ...
            <div class="form-group">
                ...
                @if ($user instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && ! $user->hasVerifiedEmail())
                    <div class="mt-2 flex items-start gap-2 p-3 bg-amber-50 border border-amber-200 rounded-xl">
                        ...
                        <div>
                            <p class="text-xs font-semibold text-amber-800">Email unverified</p>
                            <button form="send-verification" class="text-xs text-amber-700 underline hover:text-amber-900">
